...
namespace WindowsFormsApplication1.DB
{
    class ConexionMYSQL
    {
        ...
        public string MYSQL_CONECTION_NET = "Server=localhost; user ID=vendedor; Password=vendedor; Persist Security Info=true; Database=pvpatolin;";

        public string MYSQL_CONECTION_ODBC = "Driver={MySQL ODBC 5.3 ANSI Driver}; Server=localhost; User=vendedor; Password=vendedor; Database=pvpatolin; Option=3;"; 
