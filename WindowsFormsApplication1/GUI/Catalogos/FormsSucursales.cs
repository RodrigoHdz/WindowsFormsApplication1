...
{
    public partial class FormsSucursales : Form
    {
        public FormsSucursales()
        {
            InitializeComponent();
        }
        ...
        public void ENVIAR_DATOS_NUEVO_REGISTRO()
        {
            ...
            oSucursal.Codigo = this.txt_codigo.Text.Trim();
            oSucursal.Nombre_sucursal = this.txt_nom_sucursal.Text.Trim();
            oSucursal.Direccion = this.txt_direccion.Text.Trim();
            oSucursal.Responsable = this.txt_responsable.Text.Trim();
