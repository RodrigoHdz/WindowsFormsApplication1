...
namespace WindowsFormsApplication1.Catalogos
{
    public partial class FormClientes : Form
    {
        ...
        public void ENVIAR_DATOS_NUEVO_REGISTRO()
        {
            ...
            oCliente.Num_exterior = this.txt_num_exterior.Text.Trim();
            oCliente.Num_interior = this.txt_num_interior.Text.Trim();
            ...
            oCliente.Codigopostal = this.txt_cod_postal.Text.Trim();
